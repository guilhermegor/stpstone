...
# df_ = cls_.source("non_farm_payroll_components", bool_fetch=True)
# print(f"DF NON FARM PAYROLL COMPONENTS: \n{df_}")
# df_.info()

# df_ = cls_.source("non_farm_payroll_related", bool_fetch=True)
# print(f"DF NON FARM PAYROLL RELATED: \n{df_}")
# df_.info()

# df_ = cls_.source("non_farm_payroll_stats", bool_fetch=True)
# print(f"DF NON FARM PAYROLL STATS: \n{df_}")
# df_.info()

df_ = cls_.source("wages_usa", bool_fetch=True)
