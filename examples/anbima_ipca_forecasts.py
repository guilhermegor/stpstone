...
cls_ = AnbimaIPCAForecastsNextMonth(logger=None, cls_db=None)
...
cls_ = AnbimaIPCAForecastsCurrentMonth(logger=None, cls_db=None)
...
cls_ = AnbimaIPCAForecastsLTM(logger=None, cls_db=None)
