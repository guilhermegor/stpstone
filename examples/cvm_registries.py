...
# df_ = cls_.source('independent_fin_advs', bl_fetch=True)
# print(f'\n*** DF INDEPENDENT FINANCIAL ADVISORS - CVM: \n{df_}')
# df_.info()

# df_ = cls_.source('fiduciary_agents', bl_fetch=True)
# print(f'\n*** DF FIDUCIARY AGENTS - CVM: \n{df_}')
# df_.info()

# df_ = cls_.source('pubicly_traded_cos', bl_fetch=True)
# print(f'\n*** DF PUBICLY TRADED COMPANIES - CVM: \n{df_}')
# df_.info()

# df_ = cls_.source('foreign_cos', bl_fetch=True)
# print(f'\n*** DF FOREIGN COMPANIES COMPANIES - CVM: \n{df_}')
# df_.info()

# df_ = cls_.source('incentivized_cos', bl_fetch=True)
# print(f'\n*** DF INVENTIVIZED COMPANIES COMPANIES - CVM: \n{df_}')
# df_.info()

# df_ = cls_.source('securities_consultants', bl_fetch=True)
...
# df_ = cls_.source('crowdfunding', bl_fetch=True)
# print(f'\n*** DF CROWDFUNDING - CVM: \n{df_}')
# df_.info()

# df_ = cls_.source("funds_registries", bl_fetch=True)
# print(f"\n*** DF FUNDS REGISTRIES - CVM: \n{df_}")
# df_.info()

# df_ = cls_.source("funds_daily_infos", bl_fetch=True)
# print(f"\n*** DF FUNDS DAILY INFOS - CVM: \n{df_}")
# df_.info()

# df_ = cls_.source("funds_fact_sheet", bl_fetch=True)
# print(f"\n*** DF FUNDS FACT SHEET - CVM: \n{df_}")
# df_.info()

# df_ = cls_.source("funds_monthly_profile", bl_fetch=True)
...
# df_ = cls_.source("specially_constitued_investment_fund", bl_fetch=True)
# print(f"\n*** DF SPECIALLY CONSTITUED INVESTMENT FUND - CVM: \n{df_}")
# df_.info()

# df_ = cls_.source("reits_monthly_profile", bl_fetch=True)
# print(f"\n*** DF REITS MONTHLY PROFILE - CVM: \n{df_}")
# df_.info()

df_ = cls_.source("banks_registry", bl_fetch=True)
