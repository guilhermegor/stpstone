...
cls_ = B3TradingHoursExerciseBlockingOptionsAfterExerciseDate(
	date_ref=None, logger=None, cls_db=None
)
...
cls_ = B3TradingHoursOTC(date_ref=None, logger=None, cls_db=None)
...
cls_ = B3TradingHoursExchangeRateFutures(date_ref=None, logger=None, cls_db=None)
...
cls_ = B3TradingHoursCryptoFutures(date_ref=None, logger=None, cls_db=None)
...
cls_ = B3TradingHoursCommoditiesFutures(date_ref=None, logger=None, cls_db=None)
...
cls_ = B3TradingHoursRealDenominatedInterestRates(date_ref=None, logger=None, cls_db=None)

df_ = cls_.run(bool_verify=False)
print(f"DF B3 TRADING HOURS REAL DENOMINATED INTEREST RATES: \n{df_}")
df_.info()

cls_ = B3TradingHoursPMIFuture(date_ref=None, logger=None, cls_db=None)
...
cls_ = B3TradingHoursStockIndexFutures(date_ref=None, logger=None, cls_db=None)
...
cls_ = B3TradingHoursStocks(date_ref=None, logger=None, cls_db=None)
...
cls_ = B3TradingHoursOptionsExercise(date_ref=None, logger=None, cls_db=None)
