...
class TestNumHandler(TestCase):
    def setUp(self):
        ...
        self.test_cases = [
            ...
            ("EXAMPLE (912.412.911,231)", "EXAMPLE (912.412.911,231)", "EXAMPLE (912.412.911,231)"),
            ("EXAMPLE (81,234,567.1324432)", "EXAMPLE (81,234,567.1324432)", "EXAMPLE (81,234,567.1324432)"),
        ]
