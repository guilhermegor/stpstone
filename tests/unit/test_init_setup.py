...
def mock_getuser(mocker: MockerFixture) -> object:
	...
	"""
	return mocker.patch("stpstone.utils.loggs.init_setup.getuser", return_value="test_user")
...
def test_initiate_logging_invalid_dispatch(
	mock_logger: Logger, mock_create_log: object, mocker: MockerFixture
) -> None:
...
def test_initiate_logging_type_validation_logger(
	mock_create_log: object, mocker: MockerFixture
) -> None:
...
def test_initiate_logging_type_validation_path_log(
	mock_logger: Logger, mocker: MockerFixture
) -> None:
