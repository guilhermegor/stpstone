"""Unit tests for GlobalRatesSonia class."""
...
@pytest.fixture
def instance(sample_date: date) -> GlobalRatesSonia:
	"""Provide a GlobalRatesSonia instance for testing.
	...
	"""
	return GlobalRatesSonia(date_ref=sample_date)
...
def test_init_with_valid_date(sample_date: date) -> None:
	...
	None
	"""
	obj = GlobalRatesSonia(date_ref=sample_date)
...
def test_init_with_default_date() -> None:
	...
	with patch.object(DatesBRAnbima, "add_working_days", return_value=date(2025, 1, 1)):
		obj = GlobalRatesSonia()
		assert obj.date_ref == date(2025, 1, 1)


def test_get_response_success(
	instance: GlobalRatesSonia,
...
def test_reload_module() -> None:
	...
	import stpstone.ingestion.countries.ww.macroeconomics.global_rates_sonia as mod

	importlib.reload(mod)
	obj = mod.GlobalRatesSonia(date_ref=date(2025, 1, 1))
	assert obj.date_ref == date(2025, 1, 1)
