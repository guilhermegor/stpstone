...
class TestDealingExcel:
    ...
    def test_save_as_success(self, dealing_excel: DealingExcel, mock_excel_app: object,
                             mock_workbook: object, mocker: MockerFixture) -> None:
    ...
    def test_save_as_failure(self, dealing_excel: DealingExcel, mock_excel_app: object,
    ...
    def test_save_as_active_wb_success(self, dealing_excel: DealingExcel, mock_excel_app: object,
                                      mock_workbook: object, mock_dir_files_management: object,
                                      mocker: MockerFixture) -> None:
    ...
    def test_open_xl_success(self, dealing_excel: DealingExcel, mock_excel_app: object,
                             mock_workbook: object, mocker: MockerFixture) -> None:
    ...
    def test_delete_sheet_success(self, dealing_excel: DealingExcel, mock_excel_app: object,
                                 mock_workbook: object, mocker: MockerFixture) -> None:
    ...
    def test_paste_values_column_success(self, dealing_excel: DealingExcel, mock_excel_app: object,
                                        mock_workbook: object, mocker: MockerFixture) -> None:
    ...
    def test_color_range_w_rule_invalid_matching_value(
        ...
        with pytest.raises(ValueError, match="Matching value must be a string"):
            dealing_excel.color_range_w_rule("Sheet1", "A1:A10", 123, 255, mock_excel_app, 
                                             mock_workbook)
    ...
    def test_color_range_w_rule_invalid_color(
        ...
        with pytest.raises(ValueError, match="Color must be a positive integer"):
            dealing_excel.color_range_w_rule("Sheet1", "A1:A10", "test", -1, mock_excel_app, 
                                             mock_workbook)
...
class TestExcelWriter:
    ...
    def test_init_success(self, mock_excel_app: object, mock_workbook: object,
                         mocker: MockerFixture) -> None:
    ...
    def test_add_sheet_after_success(self, mock_excel_app: object, mock_workbook: object,
                                    mocker: MockerFixture) -> None:
    ...
    def test_format_range_invalid_style(self, mock_excel_app: object, mock_workbook: object,
                                       mocker: MockerFixture) -> None:
