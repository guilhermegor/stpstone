...
class TestCVMDataBanksRegistry:
	...
	def test_init_static_url(self, mock_logger: MagicMock, sample_date: date) -> None:
		...
		assert instance.url == "https://dados.cvm.gov.br/dados/INTERMED/CAD/DADOS/cad_intermed.zip"
	...
	def test_run_without_db(
		...
		"""
		with (
			patch.object(CVMDataBanksRegistry, "get_response") as mock_get_response,
			...
			patch.object(CVMDataBanksRegistry, "standardize_dataframe") as mock_standardize,
		):
