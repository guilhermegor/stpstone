...
def test_invalidate_no_condition(
	cache_invalidator: CacheInvalidator, mock_instance: object
) -> None:
...
def test_invalidate_true_condition(
	cache_invalidator: CacheInvalidator, mock_instance: object, true_condition: Callable[[], bool]
) -> None:
...
def test_invalidate_false_condition(
	cache_invalidator: CacheInvalidator, mock_instance: object, false_condition: Callable[[], bool]
) -> None:
...
def test_invalidate_missing_method(
	cache_invalidator: CacheInvalidator, mocker: MockerFixture
) -> None:
	...
	with pytest.raises(
		AttributeError, match="Cache-clearing method 'clear_cache' not found or not callable"
	):
...
def test_invalidate_non_boolean_condition(
	cache_invalidator: CacheInvalidator, mock_instance: object, mocker: MockerFixture
) -> None:
