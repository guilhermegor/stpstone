...
def test_statistical_description_valid_input(
    ...
    expected_keys = {
        "nobs", "minmax", "mean", "median", "mode", "variance_sample",
        "standard_deviation_sample", "skewness", "kurtosis"
    }
...
def test_statistical_description_single_element(
    stats_instance: StatisticalDescription
) -> None:
...
def test_mean_squared_error_fitting_precision_valid_input(
    ...
    expected_keys = {
        "mean_squared_error", "sqrt_mean_squared_error",
        "mean_absolute_squared_error", "sqrt_mean_absolute_squared_error"
    }
    assert set(result.keys()) == expected_keys
