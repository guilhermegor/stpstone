"""Unit tests for B3DailyLiquidityLimits ingestion class."""
...
# --------------------------
# Tests for B3DailyLiquidityLimits
# --------------------------
class TestB3DailyLiquidityLimits:
	"""Test cases for B3DailyLiquidityLimits class."""
	...
	def test_init_url_pattern(self) -> None:
		...
		Verifies
		--------
		- Correct URL pattern for daily liquidity limits
		- LD prefix is used in URL
		- .zip file extension
		...
		None
		"""
		instance = B3DailyLiquidityLimits()

		assert "pesquisapregao/download?filelist=LD" in instance.url
