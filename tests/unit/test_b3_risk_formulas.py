"""Unit tests for B3RiskFormulas ingestion class."""
...
from stpstone.ingestion.countries.br.exchange.b3_risk_formulas import (
	B3RiskFormulas,
)
	...
	def test_run_with_formula_dtypes(self, mock_fast_operations: dict[str, MagicMock]) -> None:
		...
		with (
			...
			mock_transform.return_value = pd.DataFrame(
				{"TIPO_REGISTRO": ["1"], "ID_FORMULA": ["FORM001"], "FILE_NAME": ["formulas.csv"]}
			)
