...
class TestPortfolioAnalysis:
    ...
    def test_max_sharpe(self, markowitz_instance: MarkowitzEff) -> None:
        ...
        expected_quantities = np.round(weights * markowitz_instance.float_prtf_notional / 
                                      result['close'])
    ...
    def test_min_sigma(self, markowitz_instance: MarkowitzEff) -> None:
        ...
        assert markowitz_instance.array_sigmas[min_risk_idx] \
            == min(markowitz_instance.array_sigmas)
...
class TestPlotting:
    ...
    def test_plot_risk_return_portfolio(
        ...
        # verify show was called if bl_show_plot is True
        if markowitz_instance.bl_show_plot:
    ...
    def test_plot_saving(
        ...
        valid_markowitz_args["bl_show_plot"] = False
