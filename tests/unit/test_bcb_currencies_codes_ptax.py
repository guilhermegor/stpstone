...
class TestBCBCurrenciesCodesPTAX:
	...
	def bcb_currencies_codes_ptax(
		...
		mocker.patch(
			"stpstone.ingestion.countries.br.macroeconomics.bcb_currencies_codes_ptax.CreateLog"
		)
		mocker.patch(
			"stpstone.ingestion.countries.br.macroeconomics.bcb_currencies_codes_ptax.HtmlHandler"
		)
		mocker.patch(
			"stpstone.ingestion.countries.br.macroeconomics"
	...
	def test_init_with_custom_params(
		...
		mocker.patch(
			"stpstone.ingestion.countries.br.macroeconomics.bcb_currencies_codes_ptax.DatesCurrent"
		)
		mocker.patch(
			"stpstone.ingestion.countries.br.macroeconomics"
			".bcb_currencies_codes_ptax.DatesBRAnbima"
		...
		instance = BCBCurrenciesCodesPTAX(date_ref=sample_date, logger=logger, cls_db=mock_session)
		assert instance.date_ref == sample_date
	...
	def test_parse_raw_file(
		...
		mocker.patch.object(bcb_currencies_codes_ptax, "get_file", return_value=mock_file)
	...
	def test_run_without_db(
		...
		None
		"""
		mocker.patch.object(bcb_currencies_codes_ptax, "get_response", return_value=mock_response)
		mocker.patch.object(
		...
		mocker.patch.object(bcb_currencies_codes_ptax, "transform_data", return_value=mock_df)
		mocker.patch.object(
