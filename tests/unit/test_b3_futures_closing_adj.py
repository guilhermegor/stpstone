...
def mock_response(mocker: MockerFixture) -> Response:
    ...
    response.text = "<html><body><table id='tblDadosAjustes'><tbody><tr><td>Test</td>" \
...
def test_transform_data(
    ...
    mocker.patch.object(b3_instance.cls_dict_handler, "pair_headers_with_data", 
                        return_value=mock_paired_data)
...
def test_empty_html_response(
    ...
    mocker.patch.object(b3_instance.cls_html_handler, "lxml_parser", 
