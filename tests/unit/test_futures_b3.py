...
def test_ars_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.ars(float_daily_settlement=1_330_099.90, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241, float_xcg_parity_usdars=1322.0) \
        - notional_from_pv.ars(float_daily_settlement=1_334_418.80, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241, float_xcg_parity_usdars=1322.0)
...
def test_can_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.can(float_daily_settlement=1_371.465, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241, float_xcg_usdcad=1.3731) \
        - notional_from_pv.can(float_daily_settlement=1_373.304, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241, float_xcg_usdcad=1.3731)
...
def test_chl_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.chl(float_daily_settlement=965_280.0, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241, float_xcg_usdclp=963.50) \
        - notional_from_pv.chl(float_daily_settlement=966_699.0, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241, float_xcg_usdclp=963.50)
...
def test_dax_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.dax(float_daily_settlement=23_958.0, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241, float_xcg_parity_eurusd=1.1696) \
        - notional_from_pv.dax(float_daily_settlement=24_079.0, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241, float_xcg_parity_eurusd=1.1696)
...
def test_ddi_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.ddi(float_daily_settlement=100_220.08, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.ddi(float_daily_settlement=99_884.03, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
...
def test_esx_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.esx(float_daily_settlement=5_362.00, float_qty=1.0, 
        float_xcg_eurbrl=6.3467) \
        - notional_from_pv.esx(float_daily_settlement=5_405.00, float_qty=1.0, 
            float_xcg_eurbrl=6.3467)
...
def test_eth_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.eth(float_daily_settlement=2_885.50, float_qty=1.0) \
...
def test_etr_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.etr(float_daily_settlement=4_367.85, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.etr(float_daily_settlement=4_453.07, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
    expected = 115.56
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_icf_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.icf(float_daily_settlement=493.45, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.icf(float_daily_settlement=481.40, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
    expected = 6_536.04
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_imv_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.imv(float_daily_settlement=2_009_731.00, float_qty=1.0, 
                                  float_xcg_arsbrl=0.00412) \
        - notional_from_pv.imv(float_daily_settlement=2_009_731.00, float_qty=1.0, 
                               float_xcg_arsbrl=0.00412)
    expected = 0.0
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_ind_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.ind(float_daily_settlement=143_883.00, float_qty=1.0) \
...
def test_isp_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.isp(float_daily_settlement=6_472.00, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.isp(float_daily_settlement=6_518.75, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
    expected = 12_678.83
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_jap_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    result = notional_from_pv.jap(float_daily_settlement=146_742.169, float_qty=1.0, 
                                  float_xcg_usbrl=5.4241, float_xcg_parity_usdjpy=146.93) \
...
def test_jse_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.jse(float_daily_settlement=94_135.0, float_qty=1.0) \
...
def test_klbni_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.klbni(float_daily_settlement=18.66, float_qty=1.0) \
...
def test_lreno_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.lreno(float_daily_settlement=16.39, float_qty=1.0) \
...
def test_mbr_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.mbr(float_daily_settlement=1_255.52, float_qty=1.0) \
...
def test_mex_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.mex(float_daily_settlement=18_681.386, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241, float_xcg_parity_mxnusd=18.6522) \
        - notional_from_pv.mex(float_daily_settlement=18_664.651, float_qty=1.0, 
                              float_xcg_usdbrl=5.4241, float_xcg_parity_mxnusd=18.6522)
    expected = 48.67
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_mgluo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.mgluo(float_daily_settlement=8.231, float_qty=1.0) \
...
def test_mxn_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.mxn(float_daily_settlement=2_914.5780, float_qty=1.0) \
...
def test_nok_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.nok(float_daily_settlement=10_049.742, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.nok(float_daily_settlement=10_053.541, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
...
def test_nzd_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.nzd(float_daily_settlement=3_213.5430, float_qty=1.0) \
...
def test_nzl_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.nzl(float_daily_settlement=590.20, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.nzl(float_daily_settlement=588.90, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
    expected = 70.51
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_oc1_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.oc1(float_daily_settlement=99_944.90, float_qty=1.0) \
...
def test_pcaro_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.pcaro(float_daily_settlement=3.58, float_qty=1.0) \
...
def test_petrp_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.petrp(float_daily_settlement=31.36, float_qty=1.0) \
...
def test_prioo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.prioo(float_daily_settlement=38.18, float_qty=1.0) \
...
def test_pssao_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.pssao(float_daily_settlement=52.17, float_qty=1.0) \
...
def test_radlo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.radlo(float_daily_settlement=17.68, float_qty=1.0) \
...
def test_railo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.railo(float_daily_settlement=14.65, float_qty=1.0) \
...
def test_rdoro_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.rdoro(float_daily_settlement=39.68, float_qty=1.0) \
...
def test_rento_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.rento(float_daily_settlement=36.14, float_qty=1.0) \
...
def test_soy_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.soy(float_daily_settlement=444.40, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.soy(float_daily_settlement=442.00, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
...
def test_suzbo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.suzbo(float_daily_settlement=52.88, float_qty=1.0) \
...
def test_swi_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.swi(float_daily_settlement=798.00, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241, float_xcg_parity_usdchf=0.7999) \
        - notional_from_pv.swi(float_daily_settlement=799.10, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241, float_xcg_parity_usdchf=0.7999)
    expected = 74.60
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_t10_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.t10(float_daily_settlement=112.500, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.t10(float_daily_settlement=112.5937, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
...
def test_try_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.try_(float_daily_settlement=130.4190, float_qty=1.0) \
...
def test_tuq_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.tuq(float_daily_settlement=41_748.80, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241, float_xcg_parity_usdtry=41.2057) \
        - notional_from_pv.tuq(float_daily_settlement=41_666.50, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241, float_xcg_parity_usdtry=41.2057)
...
def test_usima_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.usima(float_daily_settlement=4.41, float_qty=1.0) \
...
def test_valeo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.valeo(float_daily_settlement=56.01, float_qty=1.0) \
...
def test_vbbro_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.vbbro(float_daily_settlement=24.23, float_qty=1.0) \
...
def test_vivto_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.vivto(float_daily_settlement=34.12, float_qty=1.0) \
...
def test_wdo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.wdo(float_daily_settlement=5_426.40, float_qty=1.0) \
...
def test_wegeo_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.wegeo(float_daily_settlement=37.97, float_qty=1.0) \
...
def test_weu_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.weu(float_daily_settlement=6_376.8720, float_qty=1.0) \
...
def test_win_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.win(float_daily_settlement=143_883.0, float_qty=1.0) \
...
def test_wsp_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.wsp(float_daily_settlement=6_472.00, float_qty=1.0, 
                                  float_xcg_usdbrl=5.4241) \
        - notional_from_pv.wsp(float_daily_settlement=6_518.75, float_qty=1.0, 
                               float_xcg_usdbrl=5.4241)
    expected = 633.94
    assert abs(result) == pytest.approx(expected, abs=1e-2)
...
def test_xfi_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.xfi(float_daily_settlement=3_570.50, float_qty=1.0) \
...
def test_zar_delta_mtm(notional_from_pv: MTMFromDailySettlement) -> None:
    ...
    None
    """
    result = notional_from_pv.zar(float_daily_settlement=3_083.7230, float_qty=1.0) \
