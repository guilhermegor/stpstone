"""Unit tests for B3DerivativesMarketMarginScenarios ingestion class."""
...
# --------------------------
# Tests for B3DerivativesMarketMarginScenarios
# --------------------------
class TestB3DerivativesMarketMarginScenarios:
	"""Test cases for B3DerivativesMarketMarginScenarios class."""
	...
	def test_init_url_pattern(self) -> None:
		...
		None
		"""
		instance = B3DerivativesMarketMarginScenarios()

		assert "pesquisapregao/download?filelist=CN" in instance.url
