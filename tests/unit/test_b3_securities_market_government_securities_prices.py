"""Unit tests for B3SecuritiesMarketGovernmentSecuritiesPrices ingestion class."""
...
from stpstone.ingestion.countries.br.exchange.b3_securities_market_government_securities_prices import (  # noqa: E501
	...
	def test_run_with_government_securities_dtypes(
		...
		with (
			...
			mock_parse.return_value = (
				StringIO("government securities data"),
				"gov_securities.txt",
			)
