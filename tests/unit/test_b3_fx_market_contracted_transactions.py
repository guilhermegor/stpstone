"""Unit tests for B3FXMarketContractedTransactions ingestion class."""
...
# --------------------------
# Tests for B3FXMarketContractedTransactions
# --------------------------
class TestB3FXMarketContractedTransactions:
	"""Test cases for B3FXMarketContractedTransactions class."""
	...
	def test_init_url_pattern(self) -> None:
		...
		None
		"""
		instance = B3FXMarketContractedTransactions()

		assert "pesquisapregao/download?filelist=CT" in instance.url
