...
class TestFIFCDA:
    ...
    def test_init_url_construction(
        ...
        expected_url = (
            "https://dados.cvm.gov.br/dados/FI/DOC/CDA/DADOS/cda_fi_202312.zip"
        )
    ...
    def test_get_response_success(
        ...
        """
        with patch(
            "stpstone.ingestion.countries.br.registries.fif_cda.requests.get"
        ) as mock_get:
    ...
    def test_run_without_db(
        ...
        with patch.object(FIFCDA, "get_response") as mock_get_response, \
