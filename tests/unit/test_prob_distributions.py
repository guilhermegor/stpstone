...
class TestProbabilityDistributions:
    ...
    def test_chi_squared_invalid_func(
    ...
    def test_f_fisher_snedecor_valid(
        self, prob_dist: ProbabilityDistributions
    ) -> None:
...
class TestNormalDistribution:
    ...
    def test_confidence_interval_empty_data(
        self, normal_dist: NormalDistribution
    ) -> None:
    ...
    def test_confidence_interval_invalid_conf(
        self, normal_dist: NormalDistribution
    ) -> None:
...
class TestHansenSkewStudent:
    ...
    def test_loglikelihood_calculation(
        self, skew_student: HansenSkewStudent
    ) -> None:
    ...
    def test_loglikelihood_missing_input(
        self, skew_student: HansenSkewStudent
    ) -> None:
    ...
    def test_plot_functions(
        self, skew_student: HansenSkewStudent, mocker: MockerFixture
    ) -> None:
        ...
        assert mock_show.call_count == pytest.approx(0, abs=1e-4)

    def test_plot_rvspdf_invalid_size(
        self, skew_student: HansenSkewStudent
    ) -> None:
