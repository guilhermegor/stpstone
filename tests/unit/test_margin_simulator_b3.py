...
def mock_response() -> MagicMock:
	...
	"""
	response = MagicMock()
	response.json.return_value = {"ReferenceData": {"referenceDataToken": "test_token"}}
...
def test_init_valid_payload(
	valid_payload: ResultReferenceData, mock_requests_get: MagicMock, mock_response: MagicMock
) -> None:
...
@pytest.mark.parametrize("timeout", [None, 10, 10.5, (5, 10), (5.0, 10.0)])
...
def test_get_reference_data_isolated(
	mock_requests_get: MagicMock, mock_response: MagicMock, valid_payload: ResultReferenceData
) -> None:
...
def test_get_reference_data_http_error(
	mock_requests_get: MagicMock, valid_payload: ResultReferenceData
) -> None:
...
def test_risk_calculation(valid_payload: ResultReferenceData, mocker: MockerFixture) -> None:
	...
	mock_get_response.json.return_value = {"ReferenceData": {"referenceDataToken": "test_token"}}
...
def test_risk_calculation_http_error(
	valid_payload: ResultReferenceData, mocker: MockerFixture
) -> None:
...
def test_bool_verify_invalid_type(
	valid_payload: ResultReferenceData, mock_requests_get: MagicMock, mock_response: MagicMock
) -> None:
...
def test_init_invalid_dict_payload_structure(
	mock_requests_get: MagicMock, mock_response: MagicMock
) -> None:
...
def test_missing_reference_data_token(
	mock_requests_get: MagicMock, valid_payload: ResultReferenceData, mock_response: MagicMock
) -> None:
