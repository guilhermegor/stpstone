...
def mock_create_log(mocker: MockerFixture) -> CreateLog:
	...
	"""
	return mocker.patch(
		"stpstone.ingestion.countries.br.exchange.b3_warranties.CreateLog"
	).return_value
...
class TestB3WarrantiesStocksUnitsETFs:
	...
	def test_get_response_success(
		self, instance: B3WarrantiesStocksUnitsETFs, mock_response: Response, mocker: MockerFixture
	) -> None:
	...
	def test_get_href(
		...
		"""
		mocker.patch("requests.get", return_value=mock_response)
		result, url_href = instance._get_href(
			mock_response, timeout=(12.0, 21.0), bool_verify=True
		)
		assert result == mock_response
...
class TestB3WarrantiesBRSovereignBonds:
	...
	def test_transform_data(
		self, instance: B3WarrantiesBRSovereignBonds, mocker: MockerFixture
	) -> None:
		"""Test data transformation into DataFrame.
...
class TestB3WarrantiesInternationalSecurities:
	...
	def test_transform_data(
		self, instance: B3WarrantiesInternationalSecurities, mocker: MockerFixture
	) -> None:
		"""Test data transformation into DataFrame.
