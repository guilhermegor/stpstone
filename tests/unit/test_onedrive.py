...
def test_check_sync_status_default_args(
	onedrive: OneDrive, mock_dir_files_management: MagicMock
) -> None:
	...
	mock_instance.time_last_edition.assert_called_once_with("dummy_path", bool_to_datetime=True)
...
def test_check_sync_status_custom_args(
	...
	result = onedrive.check_sync_status(
		dir_path_business=custom_path, name_like=custom_pattern, bool_to_datetime=False
	)
	...
	mock_instance.time_last_edition.assert_called_once_with("dummy_path", bool_to_datetime=False)
