"""Unit tests for B3TradingHoursExerciseBlockingOptionsAfterExerciseDate class."""
...
from stpstone.ingestion.countries.br.exchange.b3_trading_hours_exercise_blocking_options_after_exercise_date import (  # noqa: E501
...
def mock_dataframe() -> pd.DataFrame:
	...
	"""
	return pd.DataFrame({"CONTRACT": ["OPT"], "EXERCISE": ["17:00"]})
...
def test_init_correct_url() -> None:
	...
	None
	"""
	instance = B3TradingHoursExerciseBlockingOptionsAfterExerciseDate(date_ref=date(2025, 9, 12))
	assert instance.url == (
...
def test_run_returns_dataframe_without_db(
	...
	None
	"""
	instance = B3TradingHoursExerciseBlockingOptionsAfterExerciseDate(
	...
	result = instance.run(
		str_table_name="br_b3_trading_hours_exercise_blocking_options_after_exercise_date"
	)
