...
# --------------------------
def test_get_individual_response_invalid_url_type(
    b3_instance: B3HistoricalSigma
) -> None:
...
def test_get_individual_response_empty_apps(
    b3_instance: B3HistoricalSigma
) -> None:
    ...
    result = b3_instance.get_individual_response(
        fstr_url=b3_instance.fstr_url_1,
        list_apps=[],
        timeout=(12.0, 21.0),
        bool_verify=True
    )
...
def test_parse_raw_file_empty_response(
    b3_instance: B3HistoricalSigma
) -> None:
...
def test_parse_raw_file_invalid_response_type(
    b3_instance: B3HistoricalSigma
) -> None:
