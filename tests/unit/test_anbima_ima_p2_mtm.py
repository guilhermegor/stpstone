"""Unit tests for AnbimaExchangeBRIMAP2MTMs ingestion class."""
...
from stpstone.ingestion.countries.br.exchange.anbima_ima_p2_mtm import (
...
# Tests
# --------------------------
class TestAnbimaExchangeBRIMAP2MTMs:
	...
	@pytest.fixture
	def ima_p2_instance_no_db(
		self,
		sample_date: date,
		mock_logger: Logger,
	) -> AnbimaExchangeBRIMAP2MTMs:
		"""Create AnbimaExchangeBRIMAP2MTMs instance without DB session.
	...
	def test_init_valid_inputs(
		...
		None
		"""
		instance = AnbimaExchangeBRIMAP2MTMs(
			date_ref=sample_date, logger=mock_logger, cls_db=mock_db_session
		)
	...
	def test_get_response_success(
		...
		result = ima_p2_instance.get_response(timeout=(12.0, 21.0), bool_verify=True)
		assert result == mock_response
		mock_requests_get.assert_called_once_with(
			ima_p2_instance.url, timeout=(12.0, 21.0), verify=True
		)
	...
	def test_run_without_db(
		self,
		ima_p2_instance_no_db: AnbimaExchangeBRIMAP2MTMs,
		mock_requests_get: MagicMock,
		mock_response: Response,
		sample_ima_p2_data: StringIO,
		mocker: MockerFixture,
		...
		result = ima_p2_instance_no_db.run()
		assert isinstance(result, pd.DataFrame)
		mock_requests_get.assert_called_once()
		ima_p2_instance_no_db.standardize_dataframe.assert_called_once()
