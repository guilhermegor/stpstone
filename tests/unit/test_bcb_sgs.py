...
def mock_playwright_scraper(mocker: MockerFixture, mock_playwright_page: MagicMock) -> MagicMock:
    ...
    mocker.patch("stpstone.ingestion.countries.br.macroeconomics.bcb_sgs.PlaywrightScraper", 
...
@pytest.mark.parametrize("invalid_codes_with_none", [
    [None]
])
...
def test_run_happy_path(
    ...
    mocker.patch.object(default_bcbsgs, "get_series_metadata", 
                       return_value=("Taxa de juros - Selic", "Selic", "Diária", "% a.d.", 
                                     "4/6/1986"))
...
def test_get_series_metadata_from_cache(
    default_bcbsgs: BCBSGS
) -> None:
    ...
    default_bcbsgs._series_names_cache[11] = (
        "Taxa de juros - Selic", "Selic", "Diária", "% a.d.", "4/6/1986"
    )
...
def test_get_series_metadata_fallback(
    default_bcbsgs: BCBSGS,
    mocker: MockerFixture
) -> None:
...
def test_run_with_db_session(
    ...
    mocker.patch("requests.get", return_value=mock_response)
    mocker.patch.object(bcbsgs, "get_series_metadata", 
                       return_value=("Taxa de juros - Selic", "Selic", "Diária", "% a.d.", 
                                     "4/6/1986"))
...
def test_get_response_none_timeout(
    default_bcbsgs: BCBSGS,
    mocker: MockerFixture
) -> None:
