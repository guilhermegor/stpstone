...
def mock_html_element() -> HtmlElement:
	...
	return fromstring(
		"<html><h2>Calendario 2025</h2><div id='panel1'><table><tbody>"
...
def test_transform_data(
	mock_html_element: HtmlElement, mock_dataframe: pd.DataFrame, mocker: MockerFixture
) -> None:
...
@pytest.mark.parametrize("invalid_timeout", ["invalid", [10, 20], {10, 20}])
