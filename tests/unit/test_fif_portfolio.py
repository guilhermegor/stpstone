"""Unit tests for FIFPortfolio ingestion module."""
...
def mock_zip_response() -> MagicMock:
    ...
    with zipfile.ZipFile(zip_buffer, "w") as zip_file:
        zip_file.writestr(
            "lamina_fi_carteira_202312.csv", "CNPJ;TP_ATIVO\n12345678000195;ACAO"
        )
...
class TestFIFPortfolio:
    ...
    def test_init_url_construction(
        ...
        expected_url = (
            "https://dados.cvm.gov.br/dados/FI/DOC/LAMINA/DADOS/lamina_fi_202312.zip"
        )
    ...
    def test_get_response_success(
        ...
        """
        with patch(
            "stpstone.ingestion.countries.br.registries.fif_portfolio.requests.get"
        ) as mock_get:
    ...
    def test_parse_raw_file_extracts_carteira(
        ...
        """
        with patch(
            "stpstone.ingestion.countries.br.registries.fif_portfolio.DirFilesManagement"
        ) as mock_dir_files:
    ...
    def test_run_without_db(
        ...
        None
        """
        with patch.object(FIFPortfolio, "get_response") as mock_get_response, \
                patch.object(FIFPortfolio, "parse_raw_file") as mock_parse, \
                patch.object(FIFPortfolio, "transform_data") as mock_transform, \
                patch.object(FIFPortfolio, "standardize_dataframe") as mock_standardize:
    ...
    def test_run_with_db(
        ...
        with patch.object(FIFPortfolio, "get_response") as mock_get_response, \
                ...
                patch.object(FIFPortfolio, "transform_data") as mock_transform, \
                patch.object(FIFPortfolio, "standardize_dataframe") as mock_standardize, \
                patch.object(FIFPortfolio, "insert_table_db") as mock_insert_db:
