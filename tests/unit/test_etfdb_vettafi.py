...
def test_run_without_db(
	...
	with (
		patch.object(etfdb_instance, "get_response", return_value=mock_web_driver) as mock_get,
...
def test_run_with_db_calls_insert(
	...
	with (
		patch.object(etfdb_instance, "get_response", return_value=mock_web_driver),
