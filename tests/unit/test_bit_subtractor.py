...
# --------------------------
def test_half_subtractor_normal_operations(
...
@pytest.mark.parametrize("a,b", [("0", 1), (0, "1"), (0.5, 1), (0, 1.0)])
...
@pytest.mark.parametrize("a,b", [(2, 1), (0, -1), (3, 4)])
...
@pytest.mark.parametrize("a,b,borrow_in", [(0, 1, 0), (0, 0, 1), (1, 1, 1)])
...
@pytest.mark.parametrize("a,b,borrow_in", [("0", 1, 0), (0, [1], 0), (0, 1, 0.5)])
...
@pytest.mark.parametrize("a,b,borrow_in", [(2, 1, 0), (0, -1, 0), (0, 1, 2)])
