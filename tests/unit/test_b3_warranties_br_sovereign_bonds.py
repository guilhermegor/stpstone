...
def mock_dates_br(mocker: MockerFixture) -> DatesBRAnbima:
	...
	dates_br = mocker.patch(
		"stpstone.ingestion.countries.br.exchange.b3_warranties_br_sovereign_bonds.DatesBRAnbima"
	)
...
def mock_dates_current(mocker: MockerFixture) -> DatesCurrent:
	...
	dates_current = mocker.patch(
		"stpstone.ingestion.countries.br.exchange.b3_warranties_br_sovereign_bonds.DatesCurrent"
	)
...
def mock_create_log(mocker: MockerFixture) -> CreateLog:
	...
	"""
	return mocker.patch(
		"stpstone.ingestion.countries.br.exchange.b3_warranties_br_sovereign_bonds.CreateLog"
	).return_value
...
def test_module_reload(
	...
	inst = stpstone.ingestion.countries.br.exchange.b3_warranties_br_sovereign_bonds.B3WarrantiesBRSovereignBonds()  # noqa: E501
