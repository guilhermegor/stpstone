...
def test_reload_module() -> None:
    ...
    import stpstone.ingestion.countries.br.exchange.consolidated_trades_after_mkt
    importlib.reload(stpstone.ingestion.countries.br.exchange.consolidated_trades_after_mkt)
    instance = B3ConsolidatedTradesAfterMarket(date_ref=date(2025, 1, 1))
