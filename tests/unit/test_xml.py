...
def test_fetch_et_success(
	xml_files_instance: XMLFiles, sample_xml_content: str, tmp_path: pytest.TempPathFactory
) -> None:
...
def test_get_attrib_node_et_success(
	xml_files_instance: XMLFiles, sample_et_element: Element
) -> None:
...
def test_memory_parser_success(xml_files_instance: XMLFiles, sample_xml_content: str) -> None:
...
def test_find_success(xml_files_instance: XMLFiles, sample_soup: BeautifulSoup) -> None:
...
def test_find_all_success(xml_files_instance: XMLFiles, sample_soup: BeautifulSoup) -> None:
...
def test_get_text_success(xml_files_instance: XMLFiles, sample_soup: BeautifulSoup) -> None:
...
def test_parser_encoding_error(
	xml_files_instance: XMLFiles, tmp_path: pytest.TempPathFactory
) -> None:
