...
def test_advanced_type_checker_return_type(advanced_class: type, mocker: MockerFixture) -> None:
    ...
    None
    """
    mocker.patch.object(advanced_class, '_type_check_config', 
                        {"strict": True, "check_returns": True})
    ...
    with pytest.raises(TypeError, 
                       match="In method bad_method return: return value must be of type int"):
...
def test_type_checker_no_type_hints(mocker: MockerFixture) -> None:
    ...
    None
    """
    mocker.patch("stpstone.transformations.validation.metaclass_type_checker.get_type_hints", 
