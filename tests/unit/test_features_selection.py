...
class TestValidationMethods:
	...
	def test_validate_array_empty(self, dimensionality_reduction: DimensionalityReduction) -> None:
	...
	def test_validate_cv_valid(self, dimensionality_reduction: DimensionalityReduction) -> None:
	...
	def test_validate_cv_invalid(self, dimensionality_reduction: DimensionalityReduction) -> None:
	...
	def test_validate_dataframe_valid(
		self, dimensionality_reduction: DimensionalityReduction, sample_dataframe: pd.DataFrame
	) -> None:
	...
	def test_validate_bins_valid(self, dimensionality_reduction: DimensionalityReduction) -> None:
...
class TestIvWoeMethods:
	...
	def test_iv_label_predictive_power(
		...
		"""
		df_ = pd.DataFrame(
			{"feature": ["A", "B", "C", "D", "E"], "iv": [0.01, 0.05, 0.2, 0.4, 0.6]}
		)
...
class TestPcaMethod:
	...
	def test_pca_invalid_input(self, dimensionality_reduction: DimensionalityReduction) -> None:
