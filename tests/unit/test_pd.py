...
def test_settingup_pandas(
    ...
    None
    """
    dealing_pd.settingup_pandas(
        int_decimal_places=5,
        bool_wrap_repr=True,
        int_max_rows=50
    )
...
def test_convert_datetime_columns_pandas_method(
    ...
    result = dealing_pd.convert_datetime_columns(
        sample_datetime_dataframe.copy(),
        ["date_str"],
        bool_pandas_convertion=True
    )
