"""Unit tests for FIFMonthlyProfile ingestion module."""
...
from stpstone.ingestion.countries.br.registries.fif_monthly_profile import FIFMonthlyProfile
...
class TestFIFMonthlyProfile:
    ...
    def test_get_response_success(
        ...
        """
        with patch(
            "stpstone.ingestion.countries.br.registries.fif_monthly_profile.requests.get"
        ) as mock_get:
    ...
    def test_run_without_db(
        ...
        None
        """
        with patch.object(FIFMonthlyProfile, "get_response") as mock_get_response, \
                patch.object(FIFMonthlyProfile, "parse_raw_file") as mock_parse, \
                patch.object(FIFMonthlyProfile, "transform_data") as mock_transform, \
                patch.object(FIFMonthlyProfile, "standardize_dataframe") as mock_standardize:
    ...
    def test_run_with_db(
        ...
        with patch.object(FIFMonthlyProfile, "get_response") as mock_get_response, \
                ...
                patch.object(FIFMonthlyProfile, "transform_data") as mock_transform, \
                patch.object(FIFMonthlyProfile, "standardize_dataframe") as mock_standardize, \
                patch.object(FIFMonthlyProfile, "insert_table_db") as mock_insert_db:
