...
def test_get_first_uppercase(
    ...
    assert list_handler.get_first_occurrence_within_list(
        sample_str_list, bl_uppercase=True) == 2
...
def test_get_first_uppercase_not_found(
    ...
    """
    assert list_handler.get_first_occurrence_within_list(
        ["apple", "banana"], bl_uppercase=True) == -1
...
def test_get_first_non_alphanumeric(
    ...
    assert list_handler.get_first_occurrence_within_list(
        test_list, bl_regex_alphanumeric_false=True) == 3
...
def test_get_first_non_alphanumeric_not_found(
    ...
    """
    assert list_handler.get_first_occurrence_within_list(
        ["abc", "123"], bl_regex_alphanumeric_false=True) == -1
...
def test_extend_lists_no_duplicates(
    ...
    list1 = [1, 2]
    list2 = [2, 3]
    result = list_handler.extend_lists(list1, list2, bl_remove_duplicates=True)
    assert result == [1, 2, 3]
...
def test_extend_lists_with_duplicates(
    ...
    list1 = [1, 2]
    list2 = [2, 3]
    result = list_handler.extend_lists(list1, list2, bl_remove_duplicates=False)
