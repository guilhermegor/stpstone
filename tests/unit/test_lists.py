...
def test_get_first_uppercase(
	...
	None
	"""
	assert list_handler.get_first_occurrence_within_list(sample_str_list, bool_uppercase=True) == 2
...
def test_get_first_uppercase_not_found(
	...
	"""
	assert (
		list_handler.get_first_occurrence_within_list(["apple", "banana"], bool_uppercase=True)
		== -1
	)
...
def test_get_first_object_occurrence(
	...
	"""
	assert (
		list_handler.get_first_occurrence_within_list(sample_str_list, obj_occurrence="banana")
		== 1
	)
...
def test_get_first_object_occurrence_not_found(
	...
	"""
	assert (
		list_handler.get_first_occurrence_within_list(sample_str_list, obj_occurrence="melon")
		== -2
	)
...
def test_get_first_non_alphanumeric(
	...
	assert (
		list_handler.get_first_occurrence_within_list(
			test_list, bool_regex_alphanumeric_false=True
		)
		== 3
	)
...
def test_get_first_non_alphanumeric_not_found(
	...
	assert (
		list_handler.get_first_occurrence_within_list(
			["abc", "123"], bool_regex_alphanumeric_false=True
		)
		== -1
	)
...
def test_get_list_until_invalid(
	...
	"""
	invalid = ["cherry"]
	result = list_handler.get_list_until_invalid_occurrences(sample_str_list, invalid)
...
def test_replace_last_occurrence_not_found(
	...
	mock_logger = mocker.Mock(spec=Logger)
	test_list = ["a", "b"]
	result = list_handler.replace_last_occurrence(test_list, "c", "x", mock_logger)
	assert result == test_list
	mock_logger.warning.assert_called_once()
