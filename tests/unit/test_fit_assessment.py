...
class TestMaxLLF:
	...
	def test_max_llf_returns_float(
		self, fit_performance: FitPerformance, sample_regression_data: tuple
	) -> None:
...
class TestCrossValidation:
	...
	def test_cross_validation_score_returns_dict(
		self,
		fit_performance: FitPerformance,
	...
	def test_cross_validation_predict_returns_dict(
		self,
		fit_performance: FitPerformance,
		dummy_regressor: BaseEstimator,
		sample_regression_data: tuple,
		...
		"""
		x, y, _ = sample_regression_data
		result = fit_performance.cross_validation(dummy_regressor, x, y, cross_val_model="predict")
		assert isinstance(result, dict)
		assert "scores" in result
		assert "mean" in result
		assert "std" in result

	def test_cross_validation_invalid_method_raises(
		self,
		fit_performance: FitPerformance,
		dummy_regressor: BaseEstimator,
		sample_regression_data: tuple,
		...
		with pytest.raises(TypeError, match="must be one of"):
			fit_performance.cross_validation(dummy_regressor, x, y, cross_val_model="invalid")
...
class TestGridSearchOptimalHyperparameters:
	...
	def test_grid_search_returns_dict(
		self,
		fit_performance: FitPerformance,
		dummy_regressor: BaseEstimator,
	...
	def test_randomized_search_returns_dict(
		self,
		fit_performance: FitPerformance,
		dummy_regressor: BaseEstimator,
		sample_param_grid: dict,
	...
	def test_grid_search_returns_dict_grid(
		self,
		fit_performance: FitPerformance,
		dummy_regressor: BaseEstimator,
		sample_param_grid: dict,
...
class TestAccuracyPredictions:
	...
	def test_accuracy_predictions_returns_dict(
		self,
		fit_performance: FitPerformance,
	...
	def test_accuracy_predictions_with_different_average(
		self,
		fit_performance: FitPerformance,
		dummy_classifier: BaseEstimator,
		sample_classification_data: tuple,
...
class TestFittingPerfEval:
	...
	def test_fitting_perf_eval_returns_dict(
		self, fit_performance: FitPerformance, sample_classification_data: tuple
	) -> None:
	...
	def test_fitting_perf_eval_with_perfect_predictions(
		self, fit_performance: FitPerformance
	) -> None:
	...
	def test_fitting_perf_eval_with_random_predictions(
		self, fit_performance: FitPerformance
	) -> None:
