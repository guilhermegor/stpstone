...
@pytest.fixture
def b3_instance(
	sample_date: date, mock_requests_get: MagicMock
) -> B3ConsolidatedTradesAfterMarket:
...
def test_get_response_invalid_timeout(
	b3_instance: B3ConsolidatedTradesAfterMarket, mock_requests_get: MagicMock, mock_backoff: None
) -> None:
...
def test_parse_raw_file(
	b3_instance: B3ConsolidatedTradesAfterMarket, mock_response: Response
) -> None:
