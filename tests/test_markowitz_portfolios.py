...
class TestMarkowitz(unittest.TestCase):
    ...
    def test_weights_wc_pos_min(self, float_rtol=1e-5, float_atol=1e-8):
        ...
        array_expected_weights = np.array([1.0, 0.0, 0.0, 0.0])
    ...
    def test_weights_wc_neg_min(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertEqual(
                str(context.exception),
                'MIN_INVEST_PER_ASSET MUST BE POSITIVE.',
            )
    ...
    def test_weights_wc_min_unbalanced(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertEqual(
                str(context.exception),
                'THE LENGTH OF MIN_INVEST_PER_ASSET '
    ...
    def test_weights_wc_none_min(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertEqual(
                str(context.exception),
                'MIN_INVEST_PER_ASSET MUST BE PROVIDED '
    ...
    def test_weights_wc_max_w(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertEqual(
                str(context.exception),
                'MIN_INVEST_PER_ASSET MUST BE BELOW 1.0',
            )
    ...
    def test_weights_woc(self, float_rtol=1e-5, float_atol=1e-8):
        ...
        bl_multiplier = False
        array_expected_weights = np.array(
