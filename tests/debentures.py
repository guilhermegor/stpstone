...
class Debentures(TestCase):
    ...
    def get_pu_historico(self, ativo: str = None, dt_ini: datetime = None, dt_fim: datetime = None):
        url_base: str='https://www.debentures.com.br/exploreosnd/consultaadados/'
    ...
    def get_precos_negociacao(self, isin: str = None, ativo: str = None, dt_ini: datetime = None, dt_fim: datetime = None):
        url_base: str='https://www.debentures.com.br/exploreosnd/consultaadados/'
