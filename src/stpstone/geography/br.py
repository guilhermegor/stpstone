...
class BrazilGeo:
    def states(self, bol_accents=True, key_nome='nome'):
        ...
        for dict_ativo in dict_message:
            ...
            if bol_accents == False:
                dict_ativo[key_nome] = StrHandler().removing_accents(
                    dict_ativo[key_nome]
                )
        # sending response
        return dict_message
    ...
    def zip_code(
        ...
        for zip_ in list_zip_codes:
            ...
            dict_zip_adresses[zip_] = [
                json_zip_codes[key_address_type],
                json_zip_codes[key_address],
                json_zip_codes[key_state],
            ]
