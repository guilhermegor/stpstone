...
class ProbStatsCharts:
    ...
    def confusion_mtx_nxn(
        ...
        bl_focus_errors=True,
        complete_saving_path=None,
        int_fill_non_error_values=0,
    ):
        """
    ...
    def ecdf_chart(self, list_ser_data, legend_position='lower right'):
        ...
        # annotate the plot
        _ = plt.legend(
            (x['legend'] for x in list_ser_data), loc=legend_position
        )
        # display the plot
        plt.show()

    def boxplot(
        self, df_data, x_axis_column_name, y_axis_column_name, x_label, y_label
    ):
        """
        ...
        """
        _ = sns.boxplot(
            x=x_axis_column_name, y=y_axis_column_name, data=df_data
        )
    ...
    def scatter_plot(
        self, x_axis_data, y_axis_data, x_axis_label, y_axis_label
    ):
        """
    ...
    def pandas_histogram_columns(
        self, dataframe, bins=None, figsize=(20, 15), complete_saving_path=None
    ):
        """
    ...
    def plot_precision_recall_vs_threshold(
        ...
        label_recall='Recall',
        line_style_precision='b--',
        line_style_recall='g-',
        line_width=2,
        label_axis_x='Threshold',
        label_axis_y='Percentage',
        font_size=16,
        bl_grid=True,
        tup_fig_size=(8, 4),
        complete_saving_path=None,
        ...
        plt.plot(
            thresholds,
            precisions[:-1],
            line_style_precision,
            label=label_precision,
    ...
    def plot_roc_curve(
        ...
        scoring_method='accuracy',
        plot_title=None,
        label_x_axis='False Positive Rate (Fall-Out)',
        label_y_axis='True Positive Rate (Recall)',
        font_size=16,
        bl_grid=True,
        tup_fig_size=(8, 4),
        complete_saving_path=None,
                ...
                for j in range(ncols):
                    ...
                    if ncols * nrows != len(subtitle_vector):
                        if figure >= len(subtitle_vector):
                            break
                    ax[i, j].hist(sample_vector[figure], nbins, limits)
                    ax[i, j].set_title(
                        subtitle_vector[figure], fontsize=subtitle_fontsize
                    )
    ...
    def plot_learning_curves(
        ...
        array_data,
        array_target,
        complete_path_save_figure=None,
        float_test_size=0.2,
        list_axis=[0, 80, 0, 3],
        line_type_training_error='r-+',
        line_type_val_error='b-',
        line_width_training_error=2,
        line_width_val_error=3,
        label_training_error='trainig_data',
        label_val_error='validation_data',
        x_label='Training set size',
        y_label='Root Mean Squared Error (RMSE)',
        plt_label='Model Perform',
        legend_plot_position='upper right',
        int_font_size=14,
    ):
        """
        ...
        X_train, X_val, y_train, y_val = train_test_split(
            array_data, array_target, test_size=float_test_size
        )
    ...
    def classification_plot_2d_ivs(
        ...
        str_ylabel,
        complete_path_save_figure=None,
        str_color_negative='salmon',
        str_color_positive='dodgerblue',
    ):
        """
