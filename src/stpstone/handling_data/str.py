...
class StrHandler:
    ...
    def letters_to_numbers(
        ...
        for i in range(
            ord(first_letter_alphabet),
            ord(first_letter_alphabet) + letters_in_alphabet,
        ):
    ...
    def alphabetic_range(self, case='upper'):
        ...
        if case == 'upper':
            ...
            raise Exception(
                'Case ought be upper or lower, although {} was given, '.format(
                    case
                )
    ...
    def remove_non_alphanumeric_chars(
        self, str_, str_pattern_maintain='[\W_]', str_replace=''
    ):
        """
