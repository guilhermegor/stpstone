...
class HandlingDicts:
    ...
    def merge_dicts(
        self, list_ser, list_keys_merge=None, bl_sum_values_key=True
    ):
        """
    ...
    def filter_list_ser(
        self, list_ser, foreigner_key, k_value, str_filter_type: str = 'equal'
    ) -> List[Dict[str, Any]]:
        """
        ...
        if str_filter_type == 'equal':
            return [
                dict_ for dict_ in list_ser if dict_[foreigner_key] == k_value
            ]
            ...
            return [
                dict_ for dict_ in list_ser if dict_[foreigner_key] in k_value
            ]
        else:
            raise ValueError(
    ...
    def replace_variables(
        dict_base: Dict[str, Any], dict_replacer: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
