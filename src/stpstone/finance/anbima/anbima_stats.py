...
class AnbimaStats:
    ...
    def pmi_hat(self):
            ...
            for i_tr, bs_tr in enumerate(bs_table.find_all('tr')):
                ...
                if i_tr == 1:
                    list_headers = [
                        ...
                        .upper()
                        .replace(
                            YAML_ANBIMA['anbima_stats']['col_ipca_eft'],
                            YAML_ANBIMA['anbima_stats']['col_pmi_eft'],
                        )
                        .replace(
                            YAML_ANBIMA['anbima_stats']['col_igpm_eft'],
                            YAML_ANBIMA['anbima_stats']['col_pmi_eft'],
                        )
                    ...
                    list_headers.extend(
                        [
                            ...
                            YAML_ANBIMA['anbima_stats'][
                                'col_period_prediction'
                            ],
                        ]
                    )
                elif i_tr > 0:
        ...
        # adding request date
        df_pmi_hat[
            YAML_ANBIMA['anbima_stats']['col_request_date'].upper()
        ] = DatesBR().curr_date
        # altering data types
        for col_ in [
            ...
            df_pmi_hat[col_] = [
                DatesBR().str_date_to_datetime(x, 'DD/MM/YY')
