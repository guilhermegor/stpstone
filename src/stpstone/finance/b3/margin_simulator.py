...
class MarginSimulatorB3:
    def __init__(
        self,
        data_payload_portfolio,
        token='79a4413f55d7d982b61c669e6dd35eea',
        ...
        self.token = (token,)
        self.hostname_api_margin_simulator_b3 = (
            hostname_api_margin_simulator_b3
        )
    ...
    def total_deficit_surplus(
        self,
        method='POST',
        app='/web/V1.0/RiskCalculation',
        value_liquidity_resource=4700000000,
        bl_verify=False,
        ...
        resp_req = request(
            method=method,
            url=self.hostname_api_margin_simulator_b3 + app,
