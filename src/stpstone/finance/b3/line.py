...
class ConnectionApi:
    ...
    def auth_header(
        ...
        method='GET',
        key_header='header',
        int_max_retrieves=1000,
        int_status_code_ok=200,
        int_status_code_iteration=400,
        bl_verify=False,
    ...
    def app_request(
        ...
        dict_params=None,
        dict_payload=None,
        bl_parse_dict_params_data=False,
        bl_retry_if_error=False,
        bl_retry_request=True,
        bl_debug_mode=False,
        int_max_retrieves=100,
        float_secs_sleep=None,
        float_secs_sleep_increase_error=1.0,
        int_status_code_ok=200,
            ...
            while (bl_retry_request == True) and (i <= int_max_retrieves):
                ...
                try:
                    ...
                    if resp_req.status_code == int_status_code_ok:
                        ...
                        float_secs_sleep_iteration += (
                            float_secs_sleep_increase_error
                        )
                    if bl_debug_mode == True:
...
class Operations(ConnectionApi):
    ...
    def exchange_limits(
        self,
        method='GET',
        app='/api/v1.0/exchangeLimits/spxi/{}',
...
class Resources(Operations):
    ...
    def instrument_informations(
        self, method='GET', app='/api/v1.0/symbol', bl_retry_if_error=True
    ):
        """
    ...
    def instrument_infos_exchange_limits(
        self,
        key_infos_id='id',
        key_exchange_limits_id='instrumentId',
        key_symbol='symbol',
    ):
        """
        DOCSTRING:
        ...
        return {
            row[key_symbol]: {
                col_: row[col_] for col_ in df_join_instruments.columns
            }
            for _, row in df_join_instruments.iterrows()
        }

    def instrument_id_by_symbol(
        self, symbol, method='GET', app='/api/v1.0/symbol/{}'
    ):
        """
...
class AccountsData(ConnectionApi):
    ...
    def spxi_get(
        self, account_id, method='GET', app='/api/v1.0/account/{}/lmt/spxi'
    ):
        """
        ...
        #   retrieving json
        return self.app_request(
            self.token, method, app.format(account_id), dict_params
        )
    ...
    def spxi_tmox_global_metrics_remove(
        self, account_id, method='DELETE', app='/api/v1.0/account/{}/lmt'
    ):
        """
        DOCSTRING:
        INPUTS:
...
class DocumentsData(ConnectionApi):
    ...
    def doc_profile(
        ...
        doc_id,
        method='GET',
        app='/api/v2.0/document/v2.0/document/{}',
        key_api_line_b3_profile_full='profileFull',
        key_api_line_b3_profile_name='profileName',
        bl_retry_if_error=True,
    ):
        """
    ...
    def spxi_get(
        self, doc_id, method='GET', app='/api/v1.0/document/{}/lmt/spxi'
    ):
        """
        ...
        #   retrieving json
        return self.app_request(
            self.token, method, app.format(doc_id), dict_params
        )
...
class ProfilesData(ConnectionApi):
    ...
    def profile_global_limits_get(
        self, prof_id, method='GET', app='/api/v1.0/riskProfile/{}/lmt'
    ):
        """
    ...
    def profile_market_limits_get(
        ...
        prof_id,
        method='GET',
        app='/api/v1.0/riskProfile/{}/lmt/mkta',
        bl_retry_if_error=True,
    ):
        """
    ...
    def profile_spxi_limits_get(
        self, prof_id, method='GET', app='/api/v1.0/riskProfile/{}/lmt/spxi'
    ):
        """
    ...
    def profile_tmox_limits_get(
        self, prof_id, method='GET', app='/api/v1.0/riskProfile/{}/lmt/tmox'
    ):
        """
...
class SystemEventManagement(ConnectionApi):
    def report(
        self,
        int_working_days_before=1,
        int_working_days_after=0,
