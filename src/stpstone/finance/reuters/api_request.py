...
class Reuters:
    ...
    def token(self, api_key, deviceid, app='service/modtoken', method='GET'):
        """
        REFERENCES: https://www.reuters.com/markets/currencies
        ...
        return HandlingObjects().literal_eval_data(
            json_response, 'getChartData(', ')'
        )
    ...
    def quotes(
        ...
        """
        return HandlingObjects().literal_eval_data(
            self.fetch_data(urljoin(app, currency), endpoint=endpoint)
        )
