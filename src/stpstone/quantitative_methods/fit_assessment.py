...
class FitPerformance:
    ...
    def bic(self, array_x, array_y, array_y_hat):
        ...
        # return bic
        return k * np.log(array_x.shape[0] + 1) + self.max_llf(
            array_x, array_y, array_y_hat
        )
    ...
    def cross_validation(
        ...
        cross_val_model='score',
        cross_val_model_method='predict_proba',
    ):
        """
    ...
    def grid_search_optimal_hyperparameters(
        ...
        array_y_real_numbers,
        num_cross_validation_splitting_strategy=5,
        bl_return_train_score=True,
        ...
        if bl_randomized_search == True:
            ...
            raise Exception(
                'grid_search_model ought be a boolean, instead it was given: '
                + '{}, please revisit the paramether.'.format(
                    bl_randomized_search
                )
            )
        # fitting model
        ...
        return {
            ...
            'mse': self.mean_squared_error(
                array_y_real_numbers, best_model_prediction
            ),
            'rmse': np.sqrt(
