...
class JobsCLI(metaclass=TypeChecker):
	...
	def get_run_metadata(
		self, filename: str = "run_metadata.json", outside_run_id: Optional[int] = None
	...
	def get_run_output(
		self, filename: str = "run_output_metadata.json", outside_run_id: Optional[int] = None
	) -> ReturnGetRunOutput:
	...
	def copy_and_run(
		...
		try:
			...
			self.cls_create_log.log_message(
				self.logger, f"Unable to fetch metadata from run: {db_cli.run_id}", "error"
			)
