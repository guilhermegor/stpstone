...
This module provides a class for interacting with Reuters API to fetch tokens and currency
quotes. It handles authentication and data retrieval from Reuters financial endpoints.
