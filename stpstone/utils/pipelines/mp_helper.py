...
@type_checker
def mp_worker(args: tuple[Callable, tuple, dict[str, Any]]) -> Any:  # noqa ANN401: typing.Any is not allowed
...
def mp_run_parallel(
	...
	args_list = [
		(func, pos_args, kw_args if kw_args else {}) for pos_args, *kw_args in list_task_args
	]
