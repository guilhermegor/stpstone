...
class DatesBR(BrazilBankCalendar, metaclass=TypeChecker):
    ...
    def date_to_datetime(self, date: date, bool_timestamp: bool = False) -> Union[int, datetime]:
        ...
        date : date
            The date to convert
        bool_crop_time : bool, optional
            Whether to crop time to midnight, by default True
        bool_timestamp : bool, optional
    ...
    def curr_date_time(
        ...
        """
        datetime_ = datetime.now().timestamp_dt() if bool_timestamp else datetime.now()
        if bool_crop_time:
    ...
    def month_number(self, dt_: datetime, bool_month_mm: bool = False) -> Union[int, str]:
    ...
    def week_name(
        self, dt_: datetime, bool_abbrv: bool = False, local_zone: Optional[str] = None
    ) -> str:
    ...
    def find_working_day(self, dt_: date, bool_next: bool = True) -> date:
