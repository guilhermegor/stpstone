...
class Arrays(metaclass=TypeChecker):
	...
	def _validate_array_not_empty(
		self, array_data: Union[NDArray, pd.DataFrame, pd.Series, list]
	) -> None:
	...
	def to_array_matrice(self, array_data: Union[NDArray, pd.DataFrame]) -> NDArray:
	...
	def to_array_vector(self, array_data: Union[NDArray, pd.Series, list]) -> NDArray:
	...
	def to_array(self, array_data: Union[NDArray, pd.DataFrame, pd.Series, list]) -> NDArray:
