...
class ListHandler:
    ...
    def get_first_occurrence_within_list(
        ...
        bl_uppercase: bool = False,
        bl_last_uppercase_before_capitalized: bool = False,
        int_error: int = -1,
        int_error_obj_occurrence: int = -2,
        bl_regex_alphanumeric_false: bool = False,
        bl_ignore_sole_letter: bool = True,
    ) -> int:
        ...
        bl_last_uppercase_before_capitalized : bool
        ...
        bl_regex_alphanumeric_false : bool
            Find first non-alphanumeric string
        bl_ignore_sole_letter : bool
        ...
        if bl_last_uppercase_before_capitalized:
        ...
        if bl_regex_alphanumeric_false:
            for i, el in enumerate(list_):
                if not el.isalnum():
                    return i
            return int_error
    ...
    def extend_lists(
        ...
        *lists: list[Any], # noqa ANN401: typing.Any is not allowed 
        bl_remove_duplicates: bool = True
    ) -> list[Any]: # noqa ANN401: typing.Any is not allowed
        ...
        *lists : list[Any]
        ...
        return self.remove_duplicates(combined) if bl_remove_duplicates else combined
