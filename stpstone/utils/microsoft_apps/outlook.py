...
class DealingOutlook:
    def send_email(
        ...
        bool_read_receipt=False,
        bool_delivery_receipt=False,
        bool_image_display=False,
    ...
    def download_attch(
        ...
        subj_sub_string,
        attch_save_path,
        bool_save_file_w_original_name=False,
        list_fileformat=None,
        outlook_subfolder=None,
        move_to_folder=None,
        save_only_first_event=False,
        bool_leave_after_first_occurance=False,
                ...
                if StrHandler().find_substr_str(message.Subject, subj_sub_string):
                    for attch_save_path in list_attch_save_path:
                        ...
                        for attch in message.Attachments:
                            ...
                            #   to local source
                            elif bool_save_file_w_original_name == False:
                        ...
                        # in case user wants to download only the first occurance, leave
                        if bool_leave_after_first_occurance == True:
