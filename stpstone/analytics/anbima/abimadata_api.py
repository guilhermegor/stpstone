...
class AnbimaDataGen:
    ...
    @property
    def access_token(self, str_app:str='oauth/access-token', str_method:str='POST') \
        -> List[Dict[str, Any]]:
                                    ...
                                    for dict_sbcls in data_cls:
                                        ...
                                        for YAML_ANBIMA['anbima_data_api']['key_sbcls'], data_sbcls in dict_sbcls.items():
                                            dict_xpt = HandlingDicts().merge_n_dicts(
                                                ...
                                                {
                                                    YAML_ANBIMA['anbima_data_api']['col_num_fnd']: int_fnd + 1,
                                                    YAML_ANBIMA['anbima_data_api']['col_num_class']: i_cls + 1,
                                                    YAML_ANBIMA['anbima_data_api']['col_num_pg']: int_pg
                                                }
                                            )
