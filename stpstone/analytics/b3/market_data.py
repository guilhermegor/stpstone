...
class MDComDinheiro:
    ...
    def indice_neg(self, list_tickers:List[str], dt_inf:datetime, dt_sup:datetime) -> List[Dict[str, Any]]:
        """
    ...
    @property
    def corporate_events(self) -> List[Dict[str, Any]]:
        """
    ...
    def trading_volume_securities(self, list_securities:str, str_benchmark:str, dt_inf:datetime, 
                                  dt_sup:datetime) -> List[Dict[str, Any]]:
        """
        DOCSTRING:
        INPUTS:
        OUTPUTS:
    ...
    def tradability_index(self, list_tickers:List[str], dt_inf:datetime, dt_sup:datetime) -> List[Dict[str, Any]]:
        """
        DOCSTRING: 
        INPUTS:
        OUTPUTS:
