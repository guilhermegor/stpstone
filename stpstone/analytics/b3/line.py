...
class ConnectionApi(metaclass=TypeCheck):
    ...
    def __init__(self, client_id:str, client_secret:str, broker_code:str, category_code:str, 
    ...
    @property
    def auth_header(self, method:str='GET', key_header:str='header', int_max_retrieves:int=1000,
                    int_status_code_ok:int=200, int_status_code_iteration:int=400, 
                    bl_verify:bool=False, app:str='/api/v1.0/token/authorization') -> str:
        # passing variables
        i = 0
    ...
    def access_token(self, method:str='POST', int_refresh_min_time:int=4000,
                     max_retrieves:int=100, int_status_code_ok:int=200,
                     int_status_code_iteration:int=400, key_refresh_token:str='refresh_token',
                     key_access_token:str='access_token',
                     key_expires_in:str='expires_in', bl_str_dict_params:bool=False,
                     bl_verify:bool=False, i_retrieves:int=0,
                     i_aux:int=0, int_expiration_time:int=0, app:str='/api/oauth/token') -> str:
        # header
        dict_headers = {
    ...
    def app_request(self, method:str, app_line_b3:str, dict_params:Optional[Dict[str, Any]]=None, 
                    dict_payload:Optional[List[Dict[str, Any]]]=None,
                    bl_parse_dict_params_data:bool=False, bl_retry_if_error:bool=False, 
                    bl_retry_request:bool=True, bl_debug_mode:bool=False, int_max_retrieves:int=100, 
                    float_secs_sleep:Optional[float]=None,
                    float_secs_sleep_increase_error:float=1.0, int_status_code_ok:int=200,
                    list_int_http_error_token:List[int]=[401]) -> Union[List[Dict[str, Any]], int]:
        # passing variables
        i = 0
...
class Operations(ConnectionApi):
    ...
    @property
    def exchange_limits(self, method:str='GET',
                        app:str='/api/v1.0/exchangeLimits/spxi/{}', bl_retry_if_error:bool=True) \
                         -> Union[List[Dict[str, Any]], int]:
        return self.app_request(self.token, method, app.format(self.broker_code),
                                bl_retry_if_error=bl_retry_if_error)

    @property
    def groups_authorized_markets(self, method:str='GET',
                                  app:str='/api/v1.0/exchangeLimits/autorizedMarkets',
                                  bl_retry_if_error:bool=True) -> Union[List[Dict[str, Any]], int]:
        return self.app_request(self.token, method, app, bl_retry_if_error=bl_retry_if_error)

    def intruments_per_group(self, group_id:str, method:str='POST', str_bl_settled:str='true',
    ...
    @property
    def authorized_markets_instruments(self, key_id:str='id', key_name:str='name',
...
class Resources(Operations):
    ...
    @property
    def instrument_informations(self, method:str='GET',
                                app:str='/api/v1.0/symbol', bl_retry_if_error:bool=True) \
                                    -> Union[List[Dict[str, Any]], int]:
        return self.app_request(self.token, method, app,
                                bl_retry_if_error=bl_retry_if_error)

    @property
    def instrument_infos_exchange_limits(self, key_infos_id:str='id',
    ...
    def instrument_id_by_symbol(self, symbol:str, method:str='GET', app:str='/api/v1.0/symbol/{}') \
         -> Union[List[Dict[str, Any]], int]:
...
class AccountsData(ConnectionApi):
    ...
    def client_infos(self, account_code:str, bl_retry_if_error:bool=True, bl_debug_mode:bool=False,
                     float_secs_sleep:Optional[float]=None, method:str='GET', 
                     app:str='/api/v1.0/account') -> Union[List[Dict[str, Any]], int]:
        # parameters
        dict_params = {
    ...
    def spxi_get(self, account_id:str, method:str='GET', app:str='/api/v1.0/account/{}/lmt/spxi') \
         -> Union[List[Dict[str, Any]], int]:
        # parameters
        dict_params = {
            'accId': account_id,
    ...
    def spxi_instrument_post(self, account_id:str, dict_payload:Union[List[Dict[str, Any]], None],
                             bl_parse_dict_params_data:bool=True, method:str='POST',
    ...
    def spxi_instrument_delete(self, account_id:str, dict_payload:Union[List[Dict[str, Any]], None],
    ...
    def spxi_tmox_global_metrics_remove(self, account_id:str, method:str='DELETE',
    ...
    def specific_global_metric_remotion(self, account_id:str, metric:str, method:str='DELETE',
...
class DocumentsData(ConnectionApi):
    ...
    def doc_info(self, doc_code:str, bl_retry_if_error:bool=True, method:str='GET', 
                 app:str='/api/v1.0/document') -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def block_unblock_doc(self, doc_id:str, bl_isblocked:bool=True, 
                          bl_parse_dict_params_data:bool=True, 
                          bl_retry_if_error:bool=True,
                          method:str='POST', app:str='/api/v1.0/document/{}') \
                          -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def update_profile(self, doc_id:str, doc_profile_id:str, bl_parse_dict_params_data:bool=True,
                       int_rmkt_evaluation:int=0, bl_retry_if_error:bool=True, method:str='POST',
    ...
    def bl_protection_mode(self, doc_id:str, bl_protect:bool=True, bl_parse_dict_params_data:bool=True,
                           bl_retry_if_error:bool=True, method:str='POST', 
                           app:str='/api/v1.0/document/{}') \
                           -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def client_infos(self, doc_id:str, bl_retry_if_error:bool=True, 
                     float_secs_sleep:Optional[float]=None, bl_debug_mode:bool=False,
                     method:str='GET', app:str='/api/v1.0/account') \
                     -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def doc_profile(self, doc_id:str, method:str='GET', app:str='/api/v2.0/document/v2.0/document/{}',
                    key_api_line_b3_profile_full:str='profileFull',
                    key_api_line_b3_profile_name:str='profileName', bl_retry_if_error:bool=True) \
                    -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def spxi_get(self, doc_id:str, method:str='GET', app:str='/api/v1.0/document/{}/lmt/spxi') \
                 -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def spxi_instrument_post(self, doc_id:str, dict_payload:Union[List[Dict[str, Any]], None],
                             bl_parse_dict_params_data=True, method='POST',
    ...
    def spxi_instrument_delete(self, doc_id:str, dict_payload:Union[List[Dict[str, Any]], None],
                               bl_parse_dict_params_data:bool=True, method:str='POST',
...
class Professional(ConnectionApi):
    ...
    def professional_code_get(self, method:str='GET',
    ...
    def professional_historic_position(self, professional_code:str, dt_beg:str, dt_end:str,
                                       int_participant_perspective_type:int=0,
                                       list_metric_type:List[int]=[
                                           1, 2, 3, 4, 6, 7, 22, 25, 26, 27, 28, 29, 36, 38, 39],
                                       entity_type:int=4, int_items_per_page:int=50, method:str='POST',
                                       app:str='https://api.line.trd.cert.bvmfnet.com.br/api/v2.0/position/hstry',
                                       bl_retry_if_error:bool=True, bl_debug_mode:bool=True,
                                       bl_parse_dict_params_data:bool=True,
                                       float_secs_sleep:Optional[float]=None) \
                                       -> Union[List[Dict[str, Any]], int]:
        """
...
class ProfilesData(ConnectionApi):
    ...
    @property
    def risk_profile(self, method:str='GET', app:str='/api/v1.0/riskProfile') \
            -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def entities_associated_profile(self, id_profile:str, method:str='GET',
                                    app:str='/api/v1.0/riskProfile/enty', bl_retry_if_error:bool=True) \
                                    -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def profile_global_limits_get(self, prof_id:str, method:str='GET',
    ...
    def profile_market_limits_get(self, prof_id:str, method:str='GET',
                                  app:str='/api/v1.0/riskProfile/{}/lmt/mkta', bl_retry_if_error:bool=True) \
                                  -> Union[List[Dict[str, Any]], int]:
        """
    ...
    def profile_spxi_limits_get(self, prof_id:str, method:str='GET',
    ...
    def profile_tmox_limits_get(self, prof_id:str, method:str='GET',
    ...
    def spxi_instrument_post(self, prof_id:str, dict_payload: List[Dict[str, Any]],
                             bl_parse_dict_params_data:bool=True, method:str='POST',
                             app:str='/api/v1.0/riskProfile/{}/lmt/tmox', bl_retry_if_error:bool=True) \
                             -> Union[List[Dict[str, Any]], int]:
        """
        DOCSTRING: SPXI INCLUSION TO DOCUMENT
        INPUTS: DOCUMENT ID, DICTIONARY PAYLOAD (LIST OF DICTIONARIES WITH KEYS: 'instrumentId': int,
...
class Monitoring(ConnectionApi):
    ...
    @property
    def alerts(self, method:str='GET', app:str='/api/v1.0/alert/lastalerts?filterRead=true',
               bl_retry_if_error:bool=True) -> Union[List[Dict[str, Any]], int]:
        """
