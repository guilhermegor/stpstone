...
class ROEDecomposition(metaclass=TypeChecker):
    ...
    def dupont_analysis(
        ...
        float_roe_3_step = float_net_profit_margin * float_asset_turnover \
        ...
        roe_5_step = float_tax_burden * float_interest_burden * float_opeating_margin \
            * float_asset_turnover * float_equity_multiplier
