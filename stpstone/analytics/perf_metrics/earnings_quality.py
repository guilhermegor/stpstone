...
class EarningsManipulation:
    ...
    def inputs_beneish_model(
        self,
        float_ar_t:float, float_sales_t:float, float_ar_tm1:float, float_sales_tm1:float,
        float_gp_tm1:float, float_gp_t:float, float_ppe_t:float, float_ca_t:float, 
        float_lti_t:float, float_lti_tm1:float, float_ta_t:float, float_ppe_tm1:float, 
        float_ca_tm1:float, float_ta_tm1:float, float_dep_tm1:float, float_dep_t:float, 
        float_sga_t:float, float_sga_tm1:float, float_inc_cont_op:float, float_cfo_t:float, 
        float_tl_t:float, float_tl_tm1:float
    ) -> Dict[str, float]:
        """
    ...
    def beneish_model(
        self, float_dsr:float, float_gmi:float, float_aqi:float, float_sgi:float, 
        float_depi:float, float_sgai:float, float_tata:float, float_lvgi:float
    ) -> float:
        """
        ...
        return (-4.84 + 0.920 * float_dsr + 0.528 * float_gmi + 0.404 * float_aqi +
                0.892 * float_sgi + 0.115 * float_depi - 0.172 * float_sgai +
                4.679 * float_tata - 0.327 * float_lvgi)
