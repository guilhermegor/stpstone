"""S&P Global corporate ratings ingestion for a single result page."""
...
class RatingsCorpSPGlobalOnePage(ABCIngestionOperations):
	...
	_TOKEN_URL = "https://disclosure-assets-mfe.prod.cdnratings.spglobal.com/config.json"  # noqa: S105
	_BEARER_URL = "https://disclosure.spglobal.com/ratings/en/regulatory/ratings-actions"
	...
	def get_bearer(self) -> str:
		...
		------
		RuntimeError
			If the bearer token is not found in network traffic.
		"""
