"""Trading Economics US Non-Farm Payroll related indicators ingestion."""
...
class TradingEconNonFarmPayrollRelated(_TradingEconBase, ABCIngestionOperations):
	...
	_XPATH = "//div[@id='ctl00_ContentPlaceHolder1_ctl00_ctl02_PanelPeers']//table//td"
	_DTYPES = {
		"COMPONENTS": str,
		"LAST": float,
		"PREVIOUS": float,
