"""Global-Rates.com interest rates and inflation data ingestion."""
...
class GlobalRatesEuribor(_GlobalRatesBase):
    ...
    _DTYPES = {"DATE": "date", "RATE_NAME": str, "RATE_VALUE": float}


class GlobalRatesLibor(_GlobalRatesBase):
...
class GlobalRatesEster(_GlobalRatesBase):
...
class GlobalRatesSonia(_GlobalRatesBase):
...
class GlobalRatesSofr(_GlobalRatesBase):
...
class GlobalRatesCentralBanks(_GlobalRatesBase):
...
class GlobalRatesUsaCpi(_GlobalRatesBase):
    ...
    _DTYPES = {"DATE": str, "RATE_NAME": str, "RATE_VALUE": float}


class GlobalRatesBritishCpi(_GlobalRatesBase):
...
class GlobalRatesCanadianCpi(_GlobalRatesBase):
...
class GlobalRatesEuropeanCpi(_GlobalRatesBase):
