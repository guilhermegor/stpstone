...
class B3BdiDerivativesCallsMostTraded(ABCIngestionOperations):
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_derivatives_calls_most_traded",
		...
		str_table_name : str
			...
			"br_b3_bdi_derivatives_calls_most_traded".
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(
				f"B3BdiDerivativesCallsMostTraded: page {int_page} fetched ({int_rows} rows)"
			),
			log_level="info",
		)
