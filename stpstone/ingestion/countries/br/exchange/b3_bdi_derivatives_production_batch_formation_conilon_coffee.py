"""B3 BDI Derivatives - Conilon coffee production batch formation ingestion."""
...
class B3BdiDerivativesProductionBatchFormationConilonCoffee(ABCIngestionOperations):
	"""B3 BDI Derivatives - Conilon coffee production batch formation ingestion class."""
	...
	def __init__(
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/CNLDistrionCoffeLocation/"
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(
				f"B3BdiDerivativesProductionBatchFormationConilonCoffee: "
