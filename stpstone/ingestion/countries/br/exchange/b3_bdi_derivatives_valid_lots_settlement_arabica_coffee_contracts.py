"""B3 BDI Derivatives - valid lots and settlement for arabica coffee contracts ingestion."""
...
class B3BdiDerivativesValidLotsSettlementArabicaCoffeeContracts(ABCIngestionOperations):
    ...
    def __init__(
        ...
        self.url_tpl = (
            f"https://arquivos.b3.com.br/bdi/table/ValidLotsSettle/"
    ...
    def run(
        ...
        str_table_name: str = (
            "br_b3_bdi_derivatives_valid_lots_settlement_arabica_coffee_contracts"
        ),
    ...
    def _log_page_progress(self, int_page: int, int_rows: int) -> None:
        ...
        self.cls_create_log.log_message(
            logger=self.logger,
            message=(
                f"B3BdiDerivativesValidLotsSettlementArabicaCoffeeContracts: "
