...
class B3BdiSecuritiesEarnings(ABCIngestionOperations):
	"""B3 BDI earnings credited for variable income securities ingestion class."""
	...
	def __init__(
		...
		int_page_max : int, optional
			...
			returns all earnings rows on a single page.
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/ProventionCreditVariable/"
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_securities_earnings",
		...
		str_table_name : str, optional
			The name of the table, by default "br_b3_bdi_securities_earnings".
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(f"B3BdiSecuritiesEarnings: page {int_page} fetched ({int_rows} rows)"),
			log_level="info",
		)
