...
class B3ConsolidatedTradesAfterMarket(ABCIngestionOperations):
    ...
    def __init__(
        ...
        self.url_token = "https://arquivos.b3.com.br/api/download/requestname?" \
    ...
    def transform_data(
        ...
        """
        df_ = pd.read_csv(file, sep=";", skiprows=2, thousands=".", decimal=",", names=[
            "RPT_DT",
            "TCKR_SYMB",
            "ISIN",
            "SGMT_NM",
