"""B3 BDI Derivatives - Type 4/5 coffee production batch formation centers ingestion."""
...
class B3BdiDerivativesProductionBatchFormation45Coffee(ABCIngestionOperations):
	"""B3 BDI Derivatives Type 4/5 coffee production batch formation centers ingestion class."""
	...
	def __init__(
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/DistrionCoffeLocation/"
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_derivatives_production_batch_formation_45_coffee",
		...
		str_table_name : str
			...
			"br_b3_bdi_derivatives_production_batch_formation_45_coffee".
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(
				f"B3BdiDerivativesProductionBatchFormation45Coffee: "
	...
	def transform_data(self, data: dict) -> pd.DataFrame:
		...
		The BatchQuant column may carry null values (group-header rows) and is
		therefore kept as float to avoid null-to-int cast failures.
