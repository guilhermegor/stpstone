...
class B3BdiBtbLoanTrades(ABCIngestionOperations):
	"""B3 BDI securities lending trades ingestion class."""
	...
	def __init__(
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/BTBTrade/"
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_btb_loan_trades",
		...
		str_table_name : str, optional
			The name of the table, by default "br_b3_bdi_btb_loan_trades".
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(f"B3BdiBtbLoanTrades: page {int_page} fetched ({int_rows} rows)"),
			log_level="info",
		)
