...
class B3WarrantiesStocksUnitsETFs(ABCIngestionOperations):
    ...
    def __init__(
        ...
        self.url = "https://www.b3.com.br/pt_br/produtos-e-servicos/compensacao-e-liquidacao/clearing/administracao-de-riscos/garantias/limites-de-renda-variavel-e-fixa/"
    ...
    def run(
        ...
        resp_req, url_href = self._get_href(resp_req=resp_req, timeout=timeout, 
    ...
    def _get_href(
        ...
        href = self.cls_html_handler.lxml_xpath(
            html_content=html_root, 
            str_xpath=xpath_href
        )[0].get("href")
        url_href = href.replace('../../../../../../../', self.url_host)
        resp_req = requests.get(url_href, 
                                timeout=timeout, 
                                verify=bool_verify)
        resp_req.raise_for_status()
...
class B3WarrantiesBRSovereignBonds(ABCIngestionOperations):
    ...
    def __init__(
        ...
        self.date_ref = date_ref or \
            self.cls_dates_br.add_working_days(self.cls_dates_current.curr_date(), -1)
        self.url_host = "https://www.b3.com.br/"
        self.url = "https://www.b3.com.br/pt_br/produtos-e-servicos/compensacao-e-liquidacao/clearing/administracao-de-riscos/garantias/garantias-aceitas/"
    ...
    def _get_href(
        ...
        tuple[Union[Response, PlaywrightPage, SeleniumWebDriver], str]
            The href object file and the URL.
        """
        xpath_href: str = '//*[@id="conteudo-principal"]/div[4]/div/div/div[2]/div[1]/div[2]/p/a'
    ...
    def transform_data(
        ...
        for file_content, filename in list_tup_files:
            excel_file = pd.ExcelFile(file_content)
            df_ = excel_file.parse(sheet_name="Títulos Públicos Federais")
            df_ = df_.rename(columns={
                "Ativo": "ATIVO", 
                "Sub Tipo": "SUBTIPO",
...
class B3WarrantiesInternationalSecurities(ABCIngestionOperations):
    """B3 Warranties - International Securities."""
