"""B3 Trading Hours Ingestion.

This module provides an ingestion class for B3 Trading Hours data.
...
class B3TradingHoursExchangeRateFutures(B3TradingHoursCore):
	...
	def run(
		...
		bool_verify: bool = True,
		bool_insert_or_ignore: bool = False,
		str_table_name: str = "br_b3_trading_hours_exchange_rate_futures",
	) -> Optional[pd.DataFrame]:
		"""Run the ingestion process.
		...
		bool_insert_or_ignore : bool, optional
		    Whether to insert or ignore the data, by default False
		str_table_name : str, optional
		    The name of the table, by default "br_b3_trading_hours_exchange_rate_futures"
...
class B3TradingHoursExerciseBlockingOptionsBeforeExerciseDate(B3TradingHoursCore):
	...
	def run(
		...
		bool_verify: bool = True,
		bool_insert_or_ignore: bool = False,
		str_table_name: str = "br_b3_trading_hours_exercise_blocking_options_before_exercise_date",
	) -> Optional[pd.DataFrame]:
		"""Run the ingestion process.
