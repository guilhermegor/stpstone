"""Brazilian IRS (Receita Federal) shareholders education (Qualificacoes) open data ingestion.

Fetches the single ZIP file (Qualificacoes.zip) from the Receita Federal NextCloud
...
_FILE_PREFIX: str = "Qualificacoes"
...
class IRSBRShareholdersEducation(ABCIngestionOperations):
	"""Brazilian IRS (Receita Federal) shareholders education (Qualificacoes) ingestion class."""
	...
	def run(
		...
		str_table_name: str = "br_irs_shareholders_education",
	) -> Optional[pd.DataFrame]:
		"""Run the ingestion process.

		Fetches ``Qualificacoes.zip``, parses the CSV inside, and returns the
		...
		str_table_name : str
			The name of the table, by default 'br_irs_shareholders_education'.
