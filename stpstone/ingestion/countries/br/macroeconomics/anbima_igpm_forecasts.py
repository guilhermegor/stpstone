"""Anbima IGPM Forecasts Ingestion Module."""
...
class AnbimaIGPMCore(ABCIngestionOperations):
    """Anbima IGPM current month forecasts."""
...
class AnbimaIGPMForecastsCurrentMonth(AnbimaIGPMCore):
    ...
    def __init__(
        ...
        """Initialize the Anbima IGPM Forecasts for the Current Month.
    ...
    def run(
        ...
        bool_verify: bool = True,
        bool_insert_or_ignore: bool = False, 
        str_table_name: str = "br_anbima_igpm_forecasts_current_month"
    ) -> Optional[pd.DataFrame]:
        """Run the Anbima IGPM Forecasts for the Current Month.
        ...
        str_table_name : str, optional
            The table name, by default "br_anbima_igpm_forecasts_current_month"
    ...
    def transform_data(self, scraper_playwright: PlaywrightScraper) -> pd.DataFrame:
        ...
        return super().transform_data(
            ...
            //*[@id="home"]/div/div[1]/table/tbody/tr[position()>1]/td
            """,
...
class AnbimaIGPMForecastsNextMonth(AnbimaIGPMCore):
    ...
    def __init__(
        ...
        """Initialize the Anbima IGPM Forecasts for the Next Month.
    ...
    def run(
        ...
        bool_verify: bool = True,
        bool_insert_or_ignore: bool = False, 
        str_table_name: str = "br_anbima_igpm_forecasts_next_month"
    ) -> Optional[pd.DataFrame]:
        """Run the Anbima IGPM Forecasts for the Next Month.
    ...
    def transform_data(self, scraper_playwright: PlaywrightScraper) -> pd.DataFrame:
        ...
        return super().transform_data(
            xpath_current_month_forecasts="""
            //*[@id="home"]/div/div[3]/table/tbody/tr[position()>1]/td
            """,
...
class AnbimaIGPMForecastsLTM(AnbimaIGPMCore):
    ...
    def __init__(
        ...
        """Initialize the Anbima IGPM Forecasts for the Last Twelve Months.
    ...
    def run(
        ...
        bool_verify: bool = True,
        bool_insert_or_ignore: bool = False, 
        str_table_name: str = "br_anbima_igpm_forecasts_ltm"
    ) -> Optional[pd.DataFrame]:
        """Run the Anbima IGPM Forecasts for the Last Twelve Months.
        ...
        bool_insert_or_ignore : bool, optional
            Insert or ignore the data, by default False
        str_table_name : str, optional
            The table name, by default "br_anbima_igpm_forecasts_ltm"
    ...
    def transform_data(self, scraper_playwright: PlaywrightScraper) -> pd.DataFrame:
        ...
        """
        xpath_current_month_forecasts="""
        //*[@id="home"]/div/div[5]/table/tbody/tr[position() > 2]/td
        """
        list_th: list[str] = [
        ...
        df_["IGPM_EFETIVO_PCT"] = df_.groupby("MES_COLETA")["IGPM_EFETIVO_PCT"]\
            .fillna(method="ffill")
        return df_
            ...
            if len(sequence) >= 5: # noqa SIM102: use a single `if` statement instead of nested `if` statements
                ...
                if (sequence[0]['type'] == 'month' and 
                    ...
                    row = {
                        ...
                        expected_columns[4]: sequence[4]['value']   # IGPM_EFETIVO_PCT
                    }
            ...
            if len(sequence) >= 4: # noqa SIM102: use a single `if` statement instead of nested `if` statements
                ...
                if (sequence[0]['type'] == 'month' and 
                    ...
                    row = {
                        ...
                        expected_columns[2]: sequence[2]['value'],  # PROJECAO_PCT
                        expected_columns[3]: sequence[3]['value'],  # DATA_VALIDADE
                        expected_columns[4]: missing_value          # IGPM_EFETIVO_PCT
                    }
                    current_month = sequence[0]['value']
                    i += 4
                    self.cls_create_log.log_message(
                ...
                if (sequence[0]['type'] == 'date' and 
                    ...
                    row = {
                        ...
                        expected_columns[4]: sequence[3]['value']   # IGPM_EFETIVO_PCT
                    }
                    i += 4
                    self.cls_create_log.log_message(
                        self.logger,
