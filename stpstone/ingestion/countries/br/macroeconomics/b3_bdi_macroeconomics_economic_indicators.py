"""B3 BDI economic indicators ingestion."""
...
class B3BdiMacroeconomicsEconomicIndicators(ABCIngestionOperations):
    """B3 BDI economic indicators ingestion class."""
    ...
    def __init__(
        ...
        self.url_tpl = (
            f"https://arquivos.b3.com.br/bdi/table/EconomicIndicators/"
    ...
    def run(
        ...
        str_table_name: str = "br_b3_bdi_macroeconomics_economic_indicators",
        ...
        str_table_name : str, optional
            ...
            "br_b3_bdi_macroeconomics_economic_indicators".
    ...
    def _log_page_progress(self, int_page: int, int_rows: int) -> None:
        ...
        self.cls_create_log.log_message(
            logger=self.logger,
            message=(
                f"B3BdiMacroeconomicsEconomicIndicators: page {int_page} "
                f"fetched ({int_rows} rows)"
            ),
            log_level="info",
        )
