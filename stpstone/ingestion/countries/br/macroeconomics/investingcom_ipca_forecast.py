...
class InvetingComIPCAForecast(ABCIngestionOperations):
	...
	def get_response(
		...
		"""
		return PlaywrightScraper(bool_headless=True, int_default_timeout=5_000, logger=self.logger)
	...
	def transform_data(self, json_: dict[str, list[list[Union[str, int, float]]]]) -> pd.DataFrame:
