...
class B3BdiDerivativesCcpRegistries(ABCIngestionOperations):
	"""B3 BDI OTC derivatives registration with CCP ingestion class."""
	...
	def __init__(
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/OTCRegistrationCCP/"
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_derivatives_ccp_registries",
		...
		str_table_name : str, optional
			...
			"br_b3_bdi_derivatives_ccp_registries".
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(f"B3BdiDerivativesCcpRegistries: page {int_page} fetched ({int_rows} rows)"),
			log_level="info",
		)
