...
class B3BdiCoeInventory(ABCIngestionOperations):
	"""B3 BDI COE inventory ingestion class."""
	...
	def __init__(
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/COEInventory/"
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_coe_inventory",
		...
		str_table_name : str, optional
			The name of the table, by default "br_b3_bdi_coe_inventory".
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(f"B3BdiCoeInventory: page {int_page} fetched ({int_rows} rows)"),
			log_level="info",
		)
