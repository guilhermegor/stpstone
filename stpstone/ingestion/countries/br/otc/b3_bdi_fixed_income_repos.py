...
class B3BdiFixedIncomeRepos(ABCIngestionOperations):
	"""B3 BDI Fixed Income Repurchase Dealings ingestion class."""
	...
	def __init__(
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/RepurchaseDealings/"
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_fixed_income_repos",
		...
		str_table_name : str, optional
			The name of the table, by default "br_b3_bdi_fixed_income_repos".
