"""Debentures.com.br scraping.

This module provides a class for ingesting data from debentures.com.br website.
...
class DebenturesComBrMTM(ABCIngestionOperations):
    ...
    def __init__(
        ...
        self.date_start = date_start or \
            self.cls_dates_br.add_working_days(self.cls_dates_current.curr_date(), -22)
    ...
    def transform_data(
        ...
        return pd.read_csv(
            ...
            sep="\t", 
            skiprows=3, 
            names=["DATA_PU", "ATIVO", "VALOR_NOMINAL", "JUROS", "PREMIO", "PRECO_UNITARIO", 
                   "CRITERIO_CALCULO", "SITUACAO"],
