...
class B3BdiFixedIncomeInstrumentsRegistration(ABCIngestionOperations):
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_fixed_income_instruments_registration",
		...
		str_table_name : str, optional
			The name of the table, by default "br_b3_bdi_fixed_income_instruments_registration".
