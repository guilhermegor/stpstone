...
class CVMWeb_WS_Funds:
    ...
    def __init__(
        ...
        self.bool_open_minimized bool_open_minimized
    ...
    def cookie_govbr(self,
        ...
        time_wait_el:int=30,
        bool_open_minimized:bool=False,
    ...
    def generic_req(self, str_method:str, url:str, str_header_ref:str, dict_data:dict={},
        bool_allow_redirects:bool=True, tup_timeout:Tuple[float, float]=(12.0, 21.0)) -> html.HtmlElement:
        """
        DOCSTRING:
        INPUTS:
        OUTPUTS:
        ...
        resp_req = request(
            ...
            allow_redirects=bool_allow_redirects,
            timeout=tup_timeout
        )
    ...
    def available_funds(
        ...
        str_method:str='GET',
        bool_allow_redirects:bool=True
    ) -> pd.DataFrame:
        """
    ...
    def fund_daily_report_gen(
        ...
        str_method:str='GET',
        bool_allow_redirects:bool=False,
