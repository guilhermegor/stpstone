...
class B3Instruments(ABCIngestionOperations):
    ...
    def __init__(
        ...
        self.token_url = f"{self.host}api/download/requestname?fileName=" \
    ...
    def transform_data(
        ...
        column_names = [
            ...
            'MTRTY_DT_TRGT_PT', 'REQRD_CONVS_IND', 'ISIN', 'CFICD', 'DLVRY_NTCE_START_DT',
            'DLVRY_NTCE_END_DT', 'OPTN_TP', 'CTRCT_MLTPLR', 'ASST_QTN_QTY', 'ALLCN_RND_LOT',
            'TRADG_CCY', 'DLVRY_TP_NM', 'WDRWL_DAYS', 'WRKG_DAYS', 'CLNR_DAYS', 
            'RLVR_BASE_PRIC_NM', 'OPNG_FUTR_POS_DAY', 'SD_TP_CD1', 'UNDRLYG_TCKR_SYMB1', 
            'SD_TP_CD2', 'UNDRLYG_TCKR_SYMB2', 'PURE_GOLD_WGHT', 'EXRC_PRIC', 'OPTN_STYLE', 
            'VAL_TP_NM', 'PRM_UPFRNT_IND', 'OPNG_POS_LMT_DT', 'DSTRBTN_ID', 'PRIC_FCTR', 
            'DAYS_TO_STTLM', 'SRS_TP_NM', 'PRTCN_FLG', 'AUTOMTC_EXRC_IND', 'SPCFCTN_CD', 
