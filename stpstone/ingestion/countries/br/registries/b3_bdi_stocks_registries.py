"""B3 BDI Instruments Equities registration ingestion."""
...
class B3BdiStocksRegistries(ABCIngestionOperations):
	"""B3 BDI Instruments Equities registration ingestion class."""
	...
	def __init__(
		...
		self.url_tpl = (
			f"https://arquivos.b3.com.br/bdi/table/InstrumentsEquities/"
	...
	def run(
		...
		str_table_name: str = "br_b3_bdi_stocks_registries",
		...
		str_table_name : str
			The name of the table, by default "br_b3_bdi_stocks_registries".
	...
	def _log_page_progress(self, int_page: int, int_rows: int) -> None:
		...
		self.cls_create_log.log_message(
			logger=self.logger,
			message=(f"B3BdiStocksRegistries: page {int_page} fetched ({int_rows} rows)"),
			log_level="info",
		)
